...
{ 
	...
	p1.heal(10); p1.addItem(sword);
	p1.addItem(potion); 
	Player p2=new Player(inv2);
	p2.heal(10); p2.addItem(shield);
	...
	world.printAllPlayers(); int total=world.getTotalValueOfWorld(); 
	System.out.println("\nTotal inventory value in the world: "+total);
	System.out.println("\n=== Battle Simulation ==="); simulateBattle(p1,goblin);
	} 
	...
	{ 
		...
		else 	if(p.getLevel()<e.getLevel()) System.out.println(e.getName()+" wins!"); 
